                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-green-sharp">
                                            <span data-counter="counterup" data-value="<?php echo $this->db->count_all('school'); ?>">0</span>
                                        </h3>
                                        <small><?php echo get_phrase('school') ?></small>
                                    </div>
                                    <div class="icon">
                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-red-haze">
                                            <span data-counter="counterup" data-value="<?php echo $this->db->count_all('teacher'); ?>">0</span>
                                        </h3>
                                        <small><?php echo get_phrase('teacher'); ?></small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-like"></i>
                                    </div>
                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" data-value="<?php echo $this->db->count_all('student'); ?>"></span>
                                        </h3>
                                        <small><?php echo get_phrase('student'); ?></small>
                                    </div>
                                    <div class="icon">
                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-purple-soft">
                                            <span data-counter="counterup" data-value="<?php echo $this->db->count_all('parent'); ?>"></span>
                                        </h3>
                                        <small><?php echo get_phrase('parent'); ?></small>
                                    </div>
                                    <div class="icon">
                                        <i class="icon-user"></i>
                                    </div>
